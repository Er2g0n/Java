...
public class UpdateStaff extends JDialog {
	...
	public UpdateStaff() {
        ...
        lblNewLabel.setBounds(33, 40, 90, 16);
        ...
        lblPrice.setBounds(33, 80, 100, 16);
        panel.add(lblPrice);
	...
	protected void btnUpdateActionPerformed(ActionEvent e) {
		...
		if (!ValidatedUtils.isValidEmail(textFieldEmail.getText().trim())) {
	        ShowMessage.showWarningMessage("Warning", "Please enter a valid email address.");
	        return;
	    }

	    if (!ValidatedUtils.isValidPhoneNumber(textFieldPhone.getText().trim())) {
	        ShowMessage.showWarningMessage("Warning", "Please enter a valid phone number (10 digits).");
	        return;
	    }
