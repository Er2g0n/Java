...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Aptech\\HK2\\java2\\ApartmentRentalManagement\\images\\householdButtonIcon.png"));
		setTitle("Main GUI");
		...
		if(staff != null) {
			...
			if (staff.getImage() != null && !staff.getImage().isEmpty()) {
	            ...
	            if (imageFile.exists()) {
	            	...
	            	String imagePathNoImage = "images/noImageIcon.png";
	            	lblImage.setIcon(new ImageIcon(new ImageIcon(imagePathNoImage)
	                        .getImage().getScaledInstance(
	                        		lblImage.getWidth() - 20,
	                        		lblImage.getHeight() - 20,
	                                Image.SCALE_SMOOTH
